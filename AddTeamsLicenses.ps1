...
$e3WithTeamsSkuId = "05e9a617-0261-4cee-bb44-138d3ef5d965" # Microsoft 365 E3
...
foreach ($user in $users) {
    ...
    $hasE3withTeams = $user.AssignedLicenses | Where-Object { $_.SkuId -eq $e3WithTeamsSkuId }
    ...
    # Perform actions only if the user has "e3 with teams" license
    if ($hasE3withTeams) {
